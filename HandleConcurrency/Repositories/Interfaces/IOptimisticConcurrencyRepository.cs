...
/// <summary>
/// Interface for repository that handles optimistic concurrency check.
/// </summary>
/// <typeparam name="TEntity">The entity type</typeparam>
public interface IOptimisticConcurrencyRepository<TEntity> where TEntity : AbstractOptimisticConcurrencyTable
{
    /// <summary>
    ...
    /// <summary>
    /// Retrieves a 'page' of records that meet the filter criteria and the PageNumber/PageSize.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves the record with the supplied porimary key.
    /// </summary>
