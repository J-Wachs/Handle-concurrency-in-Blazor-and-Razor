...
public class CustomersAPIGridModel(
    [FromKeyedServices("customerrepositoryclient")] IOptimisticConcurrencyRepository<Entity> repository
    ) : PageModel
{
    ...
    {
        var result = await repository.GetAsync(null, [], FirstPage, PageSize100);
