...
using Entity = HandleConcurrency.Data.DTOs.ProductQtyDTO;

namespace HandleConcurrencyRazorDemo.Pages;

public class ProductUpdateQtyModel(
    ...
    ) : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        var result = await repository.UpdateQuantitiesAsync(Entity!, _userName);
